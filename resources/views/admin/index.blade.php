...
@section('sidebar')
    ...
    <a href="#homeSubmenu2" aria-expanded="false" data-toggle="collapse" class="dropdown-toggle list-group-item list-group-item-action bg-light">Kelola Dokumen</a>
    <ul class="list-unstyled collapse" id="homeSubmenu2" style="">
        <li>
            <a href="{{route('files.indexfile')}}" class="list-group-item list-group-item-action bg-light">Lihat Dokumen</a>
        </li>
        <li>
            <a href="{{route('files.create')}}" class="list-group-item list-group-item-action bg-light">Tambah Dokumen</a>
        </li>
    </ul>
