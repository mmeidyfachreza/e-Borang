...
@section('subContent')
      ...
      @endif
          <div class="card bg-light">
                <div class="card-header"><div style="float:left">Kategori Dokumen Perguruan Tinggi</div>  <div style="float:right"><a class="btn btn-primary" href="{{route('katdokpt.create')}}">Tambah</a></div></div>
