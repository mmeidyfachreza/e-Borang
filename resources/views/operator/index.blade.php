...
@section('sidebar')
    ...
    <ul class="list-unstyled collapse" id="homeSubmenu" style="">
        <li>
            <a href="{{url('operator\indexfile')}}" class="list-group-item list-group-item-action bg-light">Lihat Dokumen</a>
        </li>
        <li>
            <a href="{{url('operator\tambahfile')}}" class="list-group-item list-group-item-action bg-light">Tambah Dokumen</a>
        </li>
    </ul>
    ...
    <ul class="list-unstyled collapse" id="homeSubmenu2" style="">
        ...
        <li>
            <a href="#" class="list-group-item list-group-item-action bg-light">Tambah Dokumen</a>
        </li>
    </ul>
